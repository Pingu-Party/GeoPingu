package de.pinguparty.geopingu.worker.interactions.list;
 ...
 */
public class ListGeocachesInteraction implements Interaction {
    ...
    public String getDescription() {
        return "List all geocaches of your collection.";
    }
